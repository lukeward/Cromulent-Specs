#
#  Be sure to run `pod spec lint Cromulent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Luke Ward"
  # s.authors            = { "Luke Ward" => "lward@us.ci.org" }
  # s.social_media_url   = "http://twitter.com/Luke Ward"
